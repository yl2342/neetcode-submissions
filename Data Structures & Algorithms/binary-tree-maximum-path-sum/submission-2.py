...
class Solution:
    def maxPathSum(self, root: Optional[TreeNode]) -> int:
        ...
        # or use self.res = ... is an attribute assignment on an object, 
        # not a variable assignment in the local scope — so there's no ambiguity for Python to worry about
        # minor style concern since Solution is normally reused as a stateless-ish object per LeetCode's calling convention
        self.res = root.val
